                ...
                >
                    <v-card-text>
                        <v-container>
                            <v-row>
                                <v-col cols="12">
                                    <v-text-field label="Legal full name"
                                                  v-model="fullName"
                                                  :rules="fullNameRules"
                                                  filled
                                                  rounded
        ...
        data() {
            return {
                ...
                expirationDateRules: [
                    ...
                    d => /\d{2}\/\d{2}/.test(d) || 'Month and year should have such format MM/YY',
                    d => /^([1-9]|1[0-2])\/(2[0-9])$/.test(d) || "Month should be less than 13 and year bigger than 2020"
                ],
                valid: false,
            }
        },
